...
if ($_SESSION['username'] != '') {
	echo "<script>
			window.location.href='../data-mahasiswa/index.php'
		  </script>";
	exit;
}
?>
        ...
        <div class="content">
			...
			<form method="POST" action="">
				<table>
					...
					<tr>
						<td>
							<button type="submit" name="login" class="button-simpan">Login</button>
						</td>
					</tr>
				</table>
			</form>
...
<?php 
// Koneksi ke Database
$koneksi = mysqli_connect("localhost","renzi","renzi","db_sekolah_21101152630267");

// Cek Tombol Login apakah sudah ditekan atau belum
if (isset($_POST["login"])) {

	$user = $_POST["username"];
	$passw = $_POST["password"];
	
	$result = mysqli_query($koneksi, "SELECT * FROM tbl_user WHERE username = '$user'");
